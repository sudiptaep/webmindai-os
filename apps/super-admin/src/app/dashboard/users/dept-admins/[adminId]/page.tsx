    ...
    <div className="max-w-lg">
      ...
      <div className="bg-muted rounded-lg p-4 mb-4">
        <div className="flex items-start justify-between">
          <div>
            ...
            {!!admin.faculty_title && <p className="text-muted-foreground text-xs mt-0.5">{admin.faculty_title as string}</p>}
      ...
      <div>
        ...
        <div className="space-y-1">
          ...
          {!activityQuery.data?.logs.length && <p className="text-xs text-muted-foreground">No activity recorded.</p>}
        </div>
      </div>
    </div>
  );
