      ...
      <div className="w-full max-w-sm">
        ...
        {sent ? (
          <div className="bg-gray-900 rounded-xl p-6 border border-gray-800 text-center">
            ...
            <Link href="/dept-admin/login" className="text-blue-400 hover:text-blue-300 text-sm">Back to login →</Link>
          </div>
        ) : (
          <form onSubmit={handleSubmit} className="space-y-4 bg-gray-900 rounded-xl p-6 border border-gray-800">
            ...
            <p className="text-center text-xs text-gray-600">
              <Link href="/dept-admin/login" className="hover:text-gray-400">Back to login</Link>
            </p>
          </form>
        )}
      </div>
