      ...
      <div className="w-full max-w-sm">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 bg-card rounded-xl p-6 border border-border">
          ...
          <p className="text-center text-xs text-muted-foreground mt-2">
            ...
            <Link href="/college-admin/login" className="text-primary hover:text-blue-300">College Admin Portal →</Link>
          </p>
        </form>

        <p className="text-center text-xs text-muted-foreground mt-4">
          <Link href="/dept-admin/forgot-password" className="hover:text-muted-foreground">Forgot password?</Link>
        </p>
      </div>
    </div>
  );
